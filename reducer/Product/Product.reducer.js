...
import {GET_PRODUCT_BYFILTER,GET_PRODUCT_SORT,GET_PRODUCT_FILTER,GET_PRODUCT_SUCCESS,GET_PRODUCT_LOADING,
  GET_PRODUCT_ERROR,GET_PRODUCT_BYTYPE} from './Product.type.js';
...
export const ProductReducer = (state=initialData,{type,payload}) => {
    switch(type){
      ...
      case GET_PRODUCT_FILTER : {
        let newdata = payload.data.filter((ele)=> ele.price >= payload.a && ele.price <= payload.b )
        return{
          ...state,
                loading:false,
                error:payload,
