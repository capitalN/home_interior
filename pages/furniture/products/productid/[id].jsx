...
import {
  getProduct_by_API,
  getProductIdbyAPI,
} from "@/reducer/Product/Product.API";
    ...
    <Box mt="20px" mb="20px">
      ...
      >
        ...
        <Box
          w={{ base: "95%", md: "60%" }}
          pl={{ base: "0px", md: "20px" }}
          m={{ base: "auto", md: "block" }}
        >
          <Flex alignItems="center" color="gray.700">
            <Link href={`/`}>Home</Link> <ChevronRightIcon />{" "}
            <Link href={`/furniture`}>Furniture</Link> <ChevronRightIcon />{" "}
            <Link href={`/furniture/products/${product.type}`}>
              {product.type}
            </Link>{" "}
            <ChevronRightIcon /> {product.categories}
          </Flex>
          ...
          <Flex gap={{ base: "0px", md: "10px" }} mb="20px">
            <Text>
              Save ₹ {Math.floor(product.price * (product.discount * 0.01))}
            </Text>
            <Text as="del">
              MRP ₹{" "}
          ...
          <Box m="auto" w="99%" mt="15px">
            <Image
              w="100%"
              src="https://ii2.pepperfry.com/media/wysiwyg/banners/Promo_a1_b1_c1_Web_VIPCouponRepublicSale_2X_2001_ND.jpg"
              alt="offer card"
            />
          </Box>
          <Text as="sub" mt="20px">
            Enter Pincode to get Delivery Date, Assembly Information and other
            details
          </Text>
          <Flex
            gap="20px"
            ...
            mt="10px"
          >
            <Text w="12%" fontSize="12px" fontWeight="bold">
              DELIVERY
            </Text>
            <Box>
              <InputGroup
          ...
          <Flex gap="20px" flexDirection={{ base: "column", md: "row" }}>
            ...
            <Box>
              <Text>
                Extra Rs.500 off on Kotak Bank Credit Card EMI:{" "}
                <Link fontWeight="bold" color="gray" href="">
                  {" "}
                  Code: KOTAKPF5
                </Link>
              </Text>
              <Text color="gray">
                Get flat discount of INR 500 on Kotak Bank Credit Card EMI
                transactions on a minimum purchase value of INR 3,000
              </Text>
              <Text>
                Extra Rs.500 off on BOB CCEMI Card EMI:{" "}
                <Link fontWeight="bold" color="gray" href="">
                  {" "}
                  Code: BOBPF10
                </Link>
              ...
              <Text color="gray">
                Get flat discount of INR 500 on Bank Of Baroda Credit Cards EMI
                Transactions on a minimum purchase value of INR 3,000
              </Text>
              <Text>Extra Promo Benefit</Text>
              <Text color="gray">
                Get additional coupon benefit by utilizing the cashback credits
                earned.
              </Text>
            </Box>
          </Flex>
