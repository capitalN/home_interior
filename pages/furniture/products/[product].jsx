...
const Page = () => {
  ...
  const { query = "all", print = "all" } = router.query;
          ...
          <Box className={style.sidebar} w="25%" pt="30px" pb="4rem">
            <Box className={style.filterbox}>
              ...
              <Box m="5px">
                <Checkbox
                  ...
                  isChecked={
                    category[0] && category[0].prints === "all" ? true : false
                  }
                >
                  Reset
                </Checkbox>
                ...
                <Checkbox
                  ...
                  isChecked={
                    category[0] && category[0].sort === "desc" ? true : false
                  }
                >
                  High Price First
                </Checkbox>
                ...
                <Checkbox
                  ...
                  onChange={SortHandlear}
                  isChecked={
                    category[0] && category[0].sort === "asc" ? true : false
                  }
                >
                  Low Price First
                </Checkbox>
            ...
            <Box className={style.filterbox} pt="20px">
              ...
              <Checkbox
                ...
                isChecked={
                  category[0] && category[0].prints === "Solid" ? true : false
                }
              >
                Solid
              </Checkbox>
              ...
              <Checkbox
                ...
                onChange={materialHandlear}
                isChecked={
                  category[0] && category[0].prints === "Pattern" ? true : false
                }
              >
                Pattern
              </Checkbox>
            ...
            <Box className={style.filterbox} pt="20px">
              ...
              <Checkbox
                ...
                isChecked={
                  category[0] && category[0].price === "" ? true : false
                }
              >
                Reset
              </Checkbox>
              ...
              <Checkbox
                ...
                isChecked={
                  category[0] && category[0].price === "100000" ? true : false
                }
              >
                Over ₹ 1,00,000
              </Checkbox>
              ...
              <Checkbox
                ...
                onChange={priceHandlear}
                isChecked={
                  category[0] && category[0].price === "50000-100000"
                    ? true
                    : false
                }
              >
              ...
              <Checkbox
                ...
                onChange={priceHandlear}
                isChecked={
                  category[0] && category[0].price === "25000-50000"
                    ? true
                    : false
                }
              >
              ...
              <Checkbox
                ...
                onChange={priceHandlear}
                isChecked={
                  category[0] && category[0].price === "0-25000" ? true : false
                }
              >
                Under ₹ 25000
              </Checkbox>
                    ...
                    (ele) =>
                      ele && (
                        <Box
                          key={ele && ele.id}
                          p="5px"
                          border={"2px solid #c6b38e"}
                          rounded="sm"
                        >
                          <Link
                            href={
                              ele
                                ? `/furniture/products/productid/${ele.id}`
                                : ""
                            }
                          >
                          ...
                          <Box mt="15px">
                            ...
                            <Flex gap="10px" alignItems="center">
                              ...
                              <Text color="#2e2c2c" as="del">
                                ...
                                {Math.floor(
                                  ele &&
                                    ele.price * (ele && ele.discount * 0.01)
                                ) + ele && ele.price}
                              </Text>
                            </Flex>
                            <Text
