...
const Section1 = ({
  ...
  return (
    <Flex direction="column" width="100%" p="0.3rem" gap="1rem">
      <Flex
        gap="1rem"
        ...
        alignItems="center"
      >
        <Flex flex="1" justifyContent="center" width="95%">
          <Flex
            gap="1rem"
            width="95%"
            justifyContent="center"
            ...
            <Flex>
              <Flex direction="column">
                <Text style={mediumtext}>
                  Delivery By <b>Thu, 16 Feb 2023</b>
                </Text>
              </Flex>
            </Flex>
            <Text
        ...
        <Flex direction="column" flex="2">
          <Flex direction="column">
            ...
            <Text m="0rem 0rem 1rem" style={mediumtext}>
              By Woodsworth{" "}
              <Text as="span" fontSize={12} color="#DC8109">
                36 Months' Warranty
              </Text>
            </Text>
          </Flex>
          <Flex direction="column" width="80%">
            ...
            <Stack>
              <Flex borderBottom="1px dashed grey">
                <Text p="0.5rem 0rem" style={mediumtext}>
                  MRP
                </Text>
                <Spacer />
                <Text p="0.5rem 0rem" style={mediumtext}>
                  ₹ <span style={mediumtext}>{price}</span>
                </Text>
              </Flex>
              <Flex borderBottom="1px dashed grey">
                <Text p="0.5rem 0rem" color="#67AD5B" style={mediumtext}>
                  Retail Discount
                </Text>
                <Spacer />
                <Text p="0.5rem 0rem" color="#67AD5B" style={mediumtext}>
              ...
              <Flex borderBottom="1px dashed grey">
                <Text p="1rem 0rem" as="b" style={bigtext}>
                  ITEM PRICE
                </Text>
                <Spacer />
                <Text as="b" p="0.5rem 0rem" style={bigtext}>
                  ₹{" "}
                  <span>
                    {Math.floor(price - (price * discount) / 100 + 1836)}
                  </span>
                </Text>
              </Flex>
            </Stack>
            ...
            >
              ...
              <VStack>
                <Text style={smalltext}>
                  1 Year of Furniture Protection <InfoIcon />
                </Text>
